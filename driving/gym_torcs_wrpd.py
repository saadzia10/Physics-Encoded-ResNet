...
class TorcsEnv( gym.Env):
    ...
    def __init__(self, vision=False, render=True, throttle=False, gear_change=False, race_config_path=None):
       #print("Init")
        self.vision = vision
        self.render = render
    ...
    def step(self, u, continuous=False, normalize=True):
       #print("Step")
    ...
    def make_observaton(self, raw_obs, normalize=True):
